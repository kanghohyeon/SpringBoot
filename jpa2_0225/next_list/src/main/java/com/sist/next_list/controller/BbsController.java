...
import com.sist.next_list.service.CommService;
...
public class BbsController {
    ...
    @RequestMapping("/list") // http://localhost:8080/notice/list?bname=?&...
    @ResponseBody
    public Map<String, Object> list(String bname, String searchType,
